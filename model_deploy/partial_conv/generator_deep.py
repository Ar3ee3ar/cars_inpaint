...
class InpaintingModel:
  ...
  def prepare_model(self, input_size=(32,32,3), output_type = 'inpaint'):
    ...
    conv7, mask7, conv8, mask8 = self.__encoder_layer(512, conv6, mask6, ['conv7', 'conv8'])
    conv9, mask9, conv10, mask10 = self.__encoder_layer(512, conv8, mask8, ['conv9', 'conv10'])
    conv11, mask11, conv12, mask12 = self.__encoder_layer(512, conv10, mask10, ['conv11', 'encoder_output'])

    conv9, mask9, conv10, mask10 = self.__decoder_layer(512, 128, conv8, mask8, conv7, mask7, ['conv9', 'conv10'])
    conv11, mask11, conv12, mask12 = self.__decoder_layer(512, 64, conv10, mask10, conv5, mask5, ['conv11', 'conv12'])
  ...
  def __encoder_layer(self, filters, in_layer, in_mask, names,kernel_size):
